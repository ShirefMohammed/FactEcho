 ...
 */
var deleteFileFromCloudinary = function (fileUrl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cloudinaryConfig_1.default.uploader.destroy(publicId)];
            case 1:
                // Delete the file from Cloudinary using the extracted public ID
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Error deleting file from Cloudinary:", error_1);
                return [3 /*break*/, 3];
