...
var authController_1 = require("../../controllers/v1/authController");
 ...
 *                   example: "Internal server error"
 */
router.route("/verify-account").get(authController_1.verifyAccount);
/**
 * @swagger
 ...
 *                   example: "Internal server error"
 */
router.route("/forget-password").post(authController_1.forgetPassword);
/**
 * @swagger
 * /auth/reset-password:
 *   get:
 ...
 *                   example: "Internal server error"
 */
router.route("/reset-password").get(authController_1.sendResetPasswordForm).post(authController_1.resetPassword);
/**
 * @swagger
 * /auth/login/google:
 *   get:
 ...
 *                   example: "Internal server error."
 */
router.route("/login/google").get(authController_1.loginWithGoogle);
/**
 * @swagger
 ...
 *                   example: "Internal server error."
 */
router.route("/login/google/callback").get(authController_1.loginWithGoogleCallback);
/**
 * @swagger
 * /auth/login/facebook:
 *   get:
 ...
 *                   example: "Internal server error."
 */
router.route("/login/facebook").get(authController_1.loginWithFacebook);
/**
 * @swagger
 ...
 *                   example: "Internal server error."
 */
router.route("/login/facebook/callback").get(authController_1.loginWithFacebookCallback);
