...
router
    ...
    .delete(verifyJWT_1.verifyJWT, (0, verifyRole_1.verifyRole)(rolesList_1.ROLES_LIST.Admin), usersController_1.cleanupUnverifiedUsers);
/**
 * @swagger
 * /users/{userId}:
 *   get:
 ...
 *                   example: "Internal server error."
 */
router.route("/:userId/details").patch(verifyJWT_1.verifyJWT, usersController_1.updateUserDetails);
/**
 * @swagger
 * /users/{userId}/role:
 *   patch:
...
router
    .route("/:userId/role")
    .patch(verifyJWT_1.verifyJWT, (0, verifyRole_1.verifyRole)(rolesList_1.ROLES_LIST.Admin), usersController_1.updateUserRole);
/**
 * @swagger
 ...
 *                   example: "Internal server error."
 */
router.route("/:userId/password").patch(verifyJWT_1.verifyJWT, usersController_1.updateUserPassword);
/**
 * @swagger
 * /users/{userId}/avatar:
 *   patch:
...
router
    .route("/:userId/avatar")
    .patch(verifyJWT_1.verifyJWT, (0, verifyRole_1.verifyRole)(rolesList_1.ROLES_LIST.Admin, rolesList_1.ROLES_LIST.Author), usersController_1.updateUserAvatar);
