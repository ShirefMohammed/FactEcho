...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      satoshi: ["Satoshi", "sans-serif"], // Add custom font family
    },
    screens: {
      "2xsm": "375px",
      xsm: "425px",
      "3xl": "2000px",
      ...defaultTheme.screens, // Add custom screen sizes
    },
    extend: {
      colors: {
        ...
        mainGreyColor: "var(--main-grey-color)",
        veryLightGreyColor: "var(--very-light-grey-color)",
