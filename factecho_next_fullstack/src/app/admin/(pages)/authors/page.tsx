...
import { ApiBodyResponse, GetAuthorsResponse, SearchAuthorsResponse } from "@/types/apiTypes";
...
const AdminAuthors = () => {
  ...
  useEffect(() => {
    searchKey
      ? router.push(
          `/admin/authors?searchKey=${searchKey}&page=${searchAuthorsPage}&limit=${limit}`,
        )
      : router.push(`/admin/authors?page=${authorsPage}&limit=${limit}`);
